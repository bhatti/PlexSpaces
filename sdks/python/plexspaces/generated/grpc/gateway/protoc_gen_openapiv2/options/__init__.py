...
@dataclass(eq=False, repr=False)
class EnumSchema(betterproto.Message):
    """
    ...
    read_only: bool = betterproto.bool_field(5)
    external_docs: "ExternalDocumentation" = betterproto.message_field(6)
    """Additional external documentation for this schema."""

    example: str = betterproto.string_field(7)
    ref: str = betterproto.string_field(8)
    """
...
class JsonSchemaFieldConfiguration(betterproto.Message):
    ...
    deprecated: bool = betterproto.bool_field(49)
    """
