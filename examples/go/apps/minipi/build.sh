...
go mod tidy
tinygo build -target=wasi -o minipi_actor_core.wasm .
wasm-tools component embed "$WIT_DIR" -w actor-world minipi_actor_core.wasm -o minipi_actor_embedded.wasm
wasm-tools component new minipi_actor_embedded.wasm --adapt "wasi_snapshot_preview1=$ADAPTER" -o "$OUTPUT_WASM"
rm -f minipi_actor_core.wasm minipi_actor_embedded.wasm
