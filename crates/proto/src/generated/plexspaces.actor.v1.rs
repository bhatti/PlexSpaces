...
// ActorState, ExitReason, ExitAction, ExitReasonDetails moved to types.proto (same package).
...
// SupervisionStrategy moved to supervision.proto (plexspaces.supervision.v1).
