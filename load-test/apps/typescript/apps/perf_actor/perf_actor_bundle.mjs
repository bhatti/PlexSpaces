...
var PerfActor = class extends PlexSpacesActor {
  getDefaultState() {
  ...
  onShard_task(payload) {
    ...
    const rawValues = Array.isArray(payload.values) ? payload.values : Array.from({ length: 100 }, (_, i) => i);
...
var router = new ActorRouter({ PerfActor: () => new PerfActor() });
var actor2 = {
