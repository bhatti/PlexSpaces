...
OUTPUT_WASM="$SCRIPT_DIR/data_parallel_worker_actor.wasm"
EMBEDDED_WASM="$SCRIPT_DIR/data_parallel_worker_embedded.wasm"
BUILD_PROFILE="${CARGO_PROFILE:-debug}"
PROFILE_FLAG=""
if [ "$BUILD_PROFILE" = "release" ]; then
  PROFILE_FLAG="--release"
fi
CORE_WASM="$REPO_ROOT/target/wasm32-wasip1/$BUILD_PROFILE/data_parallel_worker_wasm.wasm"
...
echo "Building Data-parallel worker (Rust WASM, scatter/gather)..."
