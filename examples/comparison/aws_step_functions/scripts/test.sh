...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "AWS Step Functions Comparison - Test Script"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
timeout 60 cargo run --release 2>&1 | tee /tmp/aws_step_functions_output.log
if [ ${PIPESTATUS[0]} -ne 0 ]; then
...
if grep -q "Workflow completed" /tmp/aws_step_functions_output.log; then
    echo "✅ Found 'Workflow completed'"
else
