...
struct ReleaseToml {
    ...
    #[serde(default)]
    applications: Vec<ApplicationSpecToml>,
    #[serde(default)]
...
impl Release {
    ...
    pub fn get_applications_in_start_order(&self) -> Result<Vec<&ApplicationSpec>, ReleaseError> {
        use std::collections::{HashMap, HashSet};

        // Build dependency graph
        let mut app_map: HashMap<String, &ApplicationSpec> = HashMap::new();
        ...
        let mut sorted: Vec<&ApplicationSpec> = Vec::new();
    ...
    pub fn get_applications_in_shutdown_order(
        &self,
    ) -> Result<Vec<&ApplicationSpec>, ReleaseError> {
            ...
            .map(|app| {
                ...
                ApplicationSpec {
                    ...
                    shutdown_timeout: Some(prost_types::Duration {
                        seconds: app.shutdown_timeout_seconds as i64,
                        nanos: 0,
                    }),
