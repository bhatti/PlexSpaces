...
impl ApplicationController {
    ...
    ///
    /// ## Errors
    /// - `ApplicationError::StartupFailed` if application already loaded
    pub async fn load(
        &self,
    ...
    /// - `ApplicationError::StartupFailed` if start fails or dependency fails
    /// - `ApplicationError::StartupFailed` if circular dependency detected
    /// - `ApplicationError::StartupFailed` if missing dependency
    ///
    ...
    /// ## Errors
    /// - `ApplicationError::NotFound` if application not loaded
    /// - `ApplicationError::ShutdownFailed` if stop fails or times out
