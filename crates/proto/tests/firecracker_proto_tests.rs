...
mod tests {
    ...
    use plexspaces_proto::firecracker::v1::{
        BootSource, CreateVmRequest, DeployApplicationRequest, DeployApplicationResponse, Drive,
        UndeployApplicationRequest, UndeployApplicationResponse, VmConfig, VmInstance,
    };
