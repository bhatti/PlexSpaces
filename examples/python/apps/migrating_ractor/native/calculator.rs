...
//
// This is the native Ractor implementation for comparison.
// The PlexSpaces Python WASM version achieves the same functionality
// using @actor decorators and @handler message routing.
