#!/bin/bash
# Build HPC Ensemble actor WASM (Python) - EFlows4HPC style
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../" && pwd)"
SDK_DIR="$PROJECT_ROOT/sdks/python"
ACTOR_NAME="ensemble_actor"
...
echo "Building $ACTOR_NAME (Python workflow + tuple space scatter/gather - EFlows4HPC-style)..."
