...
mod sqlite_tests {
    ...
    async fn test_facet_before_method_writes() {
        ...
        facet
            .before_method("test_method", &payload, &std::collections::HashMap::new())
            .await
            .unwrap();
    ...
    async fn test_facet_after_method_writes() {
        ...
        facet
            .before_method("test_method", &[], &std::collections::HashMap::new())
            .await
            .unwrap();
    ...
    async fn test_facet_attach_no_replay_with_entries() {
        ...
        facet
            .before_method("new_method", &[], &std::collections::HashMap::new())
            .await
            .unwrap();
        facet
            .after_method("new_method", &[], &[], &std::collections::HashMap::new())
            .await
            .unwrap();
