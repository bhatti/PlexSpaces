...
//! CRDT Lattice implementations for PlexSpaces
//!
//! This crate provides Conflict-Free Replicated Data Type (CRDT) lattice
//! implementations that enable coordination-free distributed systems.
//!
//! ## Lattice Types
//!
