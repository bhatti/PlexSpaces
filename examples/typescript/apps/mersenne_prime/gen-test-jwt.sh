...
#
# Generate a test JWT for the mersenne_prime example.
...
NAMESPACE="${PLEXSPACES_MERSENNE_NAMESPACE:-ts-mersenne-prime}"
...
echo "# Paste the token value into the JWT Token field in the browser UI." >&2
