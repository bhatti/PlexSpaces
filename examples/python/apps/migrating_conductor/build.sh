#!/bin/bash
# Build Order Saga Workflow WASM actor (Python) - Netflix Conductor/Orkes style
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../" && pwd)"
SDK_DIR="$PROJECT_ROOT/sdks/python"
ACTOR_NAME="order_saga_actor"
...
echo "Building $ACTOR_NAME (Python workflow_actor - order saga)..."
