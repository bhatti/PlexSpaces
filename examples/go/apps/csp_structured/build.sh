#!/usr/bin/env bash
# Build CSP Structured WASM using TinyGo
...
CORE_WASM="$TARGET_DIR/csp_structured_core.wasm"
EMBEDDED_WASM="$TARGET_DIR/csp_structured_embedded.wasm"
OUTPUT_WASM="$TARGET_DIR/csp_structured.wasm"
...
echo "Building CSP Structured (Go WASM)..."
