...
// sweep_actor.ts
var SIMULATION_MS = 22;
var TUPLE_PREFIX = "merlin";
var WORKER_GROUP = "merlin-workers";
var POOL_NAME = "merlin-workers";
var MAX_CHECKOUT_WORKERS = 10;
var GATHER_POLL_MAX = 200;
var CHECKOUT_TIMEOUT_MS = 5e3;
var SweepActor = class extends WorkflowActor {
  getDefaultState() {
    return {
      sweep_id: "",
      num_params: 0,
  ...
  run(payload) {
    ...
    const pattern = [TUPLE_PREFIX, this.state.sweep_id, "result", null, null];
  ...
  onWork_available(payload) {
    ...
    const t0 = host.nowMs();
    const pattern = [TUPLE_PREFIX, sweepId, "task", null, null];
    let processed = 0;
    let computeMs = 0;
    while (true) {
...
var actorInstance = new SweepActor();
var actor2 = {
