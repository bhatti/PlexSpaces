...
class SecurityConfig(betterproto.Message):
    ...
    oidc: "__security_v1__.OidcConfig" = betterproto.message_field(6)
    """
    OIDC/OAuth2 configuration for dashboard UI login.
    
     Only active when disable_auth = false. In non-auth mode everyone is admin.
     Supports any OIDC-compliant provider (Google, GitHub, Okta, Auth0, etc.)
     Client secret should be set via PLEXSPACES_OIDC_CLIENT_SECRET env var.
    """
