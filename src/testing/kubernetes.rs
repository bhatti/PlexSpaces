...
//! Kubernetes pod test environment
//!
//! Actors run as Kubernetes pods with orchestration and scaling.
...
#[async_trait]
impl TestEnvironment for KubernetesEnvironment {
    ...
    async fn deploy_actor(&self, _config: ActorConfig) -> Result<ActorHandle, TestError> {
        ...
        Err(TestError::EnvironmentError(
            "Kubernetes not yet implemented".to_string(),
        ))
    }
