...
TARGET_DIR="$REPO_ROOT/target/examples/typescript/llm_workflow_orchestrator"
OUTPUT_WASM="$TARGET_DIR/llm_workflow_orchestrator_actor.wasm"
ACTOR_NAME="llm_workflow_orchestrator_actor"
...
echo "Built TypeScript LLM workflow orchestrator WASM component at $OUTPUT_WASM"
