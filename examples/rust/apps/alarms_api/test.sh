...
WASM_FILE="$SCRIPT_DIR/alarms_api_actor.wasm"
CONFIG_FILE="$SCRIPT_DIR/app-config.toml"
HTTP_PORT="${1:-${HTTP_PORT:-8091}}"
HTTP_HOST="${HTTP_HOST:-127.0.0.1}"

APP_ID="rs-alarms-api"
...
echo "================================================================"
echo -e "  ${GREEN}Alarms API (Rust) Test Complete${NC}"
echo "================================================================"
