...
--
-- TupleSpace Barriers and Watchers for SQLite
--
-- ## Purpose
...
CREATE TABLE IF NOT EXISTS barriers (
    ...
    completed_at INTEGER,                -- When barrier released (UNIX timestamp)
    expires_at INTEGER                  -- Optional timeout (UNIX timestamp)
);
...
CREATE TABLE IF NOT EXISTS watchers (
    ...
    created_at INTEGER NOT NULL DEFAULT (strftime('%s', 'now')),  -- UNIX timestamp
    last_notified_at INTEGER,           -- UNIX timestamp
