...
# Test Alarms API — TypeScript WASM
#
...
WASM_FILE="$SCRIPT_DIR/alarm_queue_actor.wasm"
CONFIG_FILE="$SCRIPT_DIR/app-config.toml"
HTTP_PORT="${1:-${HTTP_PORT:-8091}}"
HTTP_HOST="${HTTP_HOST:-127.0.0.1}"

APP_ID="ts-alarms-api"
...
echo "================================================================"
echo "  Alarms API — TypeScript WASM"
...
# ── Step 2: Reset queue (ensure clean state) ──────────────────────────────────
...
echo "================================================================"
echo -e "  ${GREEN}Alarms API (TypeScript) Test Complete${NC}"
echo "================================================================"
