...
pub struct JwtConfig {
    ...
    /// EC P-256 private key in PEM format (for ES256 signing).
    /// Set via PLEXSPACES_JWT_PRIVATE_KEY env var.
    #[prost(string, tag="11")]
    pub private_key_pem: ::prost::alloc::string::String,
    /// Path to EC P-256 private key file. Auto-generates if missing.
    /// Set via PLEXSPACES_JWT_PRIVATE_KEY_FILE env var.
    #[prost(string, tag="12")]
    pub private_key_file: ::prost::alloc::string::String,
    /// Auto-generate ES256 key pair on startup when no key is configured.
    #[prost(bool, tag="13")]
