#!/bin/bash
# Build Insurance Claim Workflow WASM actor (Python) - Zeebe/Camunda style
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../" && pwd)"
SDK_DIR="$PROJECT_ROOT/sdks/python"
ACTOR_NAME="claim_workflow_actor"
...
echo "Building $ACTOR_NAME (Python workflow_actor + reminder - claim)..."
