...
/// Storage provider types (kept for reference; tuplespace now uses shared db from RuntimeConfig)
#[derive(Clone, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum StorageProvider {
    StorageProviderUnspecified = 0,
    /// Redis with pub/sub
    StorageProviderRedis = 1,
    /// PostgreSQL with JSONB
    StorageProviderPostgres = 2,
    /// SQLite embedded
    StorageProviderSqlite = 3,
}
