...
# sources: plexspaces/v1/actors/actor_runtime.proto, plexspaces/v1/actors/types.proto
...
class ActorErrorCode(betterproto.Enum):
...
class ActorIdErrorCode(betterproto.Enum):
...
class SupervisorErrorCode(betterproto.Enum):
...
class GenServerErrorCode(betterproto.Enum):
...
class FsmErrorCode(betterproto.Enum):
...
class EventErrorCode(betterproto.Enum):
...
class WorkflowRefErrorCode(betterproto.Enum):
...
class ActorVisibility(betterproto.Enum):
    """
...
class ActorConfig(betterproto.Message):
    ...
    supervision_strategy: "__supervision_v1__.SupervisionStrategy" = (
...
class ActorSpawnSpec(betterproto.Message):
    ...
    facets: List["__common_v1__.Facet"] = betterproto.message_field(8)
    """
    ...
    config: "ActorConfig" = betterproto.message_field(10)
    """
