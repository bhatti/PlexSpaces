#!/bin/bash
# Build Spot Job Runner WASM actor (Python) - SkyPilot style
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../" && pwd)"
ACTOR_NAME="job_runner_actor"
...
echo "Building $ACTOR_NAME (Python workflow + KV checkpoint - SkyPilot-style)..."
