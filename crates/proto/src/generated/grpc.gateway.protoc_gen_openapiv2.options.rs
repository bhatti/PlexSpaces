...
pub mod security_scheme {
    ...
    impl Type {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Type::TypeInvalid => "TYPE_INVALID",
                Type::TypeBasic => "TYPE_BASIC",
                Type::TypeApiKey => "TYPE_API_KEY",
                Type::TypeOauth2 => "TYPE_OAUTH2",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "TYPE_BASIC" => Some(Self::TypeBasic),
                "TYPE_API_KEY" => Some(Self::TypeApiKey),
                "TYPE_OAUTH2" => Some(Self::TypeOauth2),
                _ => None,
            }
        }
    }
    ...
    impl In {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                In::InInvalid => "IN_INVALID",
                In::InQuery => "IN_QUERY",
                In::InHeader => "IN_HEADER",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "IN_INVALID" => Some(Self::InInvalid),
                "IN_QUERY" => Some(Self::InQuery),
                "IN_HEADER" => Some(Self::InHeader),
                _ => None,
            }
        }
    }
    ...
    impl Flow {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Flow::FlowInvalid => "FLOW_INVALID",
                Flow::FlowImplicit => "FLOW_IMPLICIT",
                Flow::FlowPassword => "FLOW_PASSWORD",
                Flow::FlowApplication => "FLOW_APPLICATION",
                Flow::FlowAccessCode => "FLOW_ACCESS_CODE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "FLOW_INVALID" => Some(Self::FlowInvalid),
                "FLOW_IMPLICIT" => Some(Self::FlowImplicit),
                "FLOW_PASSWORD" => Some(Self::FlowPassword),
                "FLOW_APPLICATION" => Some(Self::FlowApplication),
                "FLOW_ACCESS_CODE" => Some(Self::FlowAccessCode),
                _ => None,
            }
        }
    }
