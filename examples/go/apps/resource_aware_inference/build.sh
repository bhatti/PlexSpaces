...
OUTPUT_WASM="$SCRIPT_DIR/resource_aware_inference_actor.wasm"

cd "$SCRIPT_DIR"

echo "Building Resource-Aware Inference (Go WASM)..."
...
rm -f resource_aware_inference_actor_core.wasm resource_aware_inference_actor_embedded.wasm
