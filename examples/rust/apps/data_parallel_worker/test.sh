...
WASM_FILE="$SCRIPT_DIR/data_parallel_worker_actor.wasm"
...
APP_ID="data-parallel-worker-rust"
APP_NAME="data-parallel-worker-rust"
LEADER_ACTOR="leader"
PARAM_COUNT=8192
WORKER_COUNT=16
ITERATIONS=20
...
TEMP_CONFIG="$(mktemp -t data-parallel-worker-app-config)"
...
echo "Step 3: Metrics"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
export DATA_PARALLEL_WALL_MS="$wall_ms"
export DATA_PARALLEL_EXPECTED_NODES="${#NODE_LIST[@]}"
...
wall_ms = int(os.environ.get("DATA_PARALLEL_WALL_MS", "0"))
...
expected_nodes = int(os.environ.get("DATA_PARALLEL_EXPECTED_NODES", "1"))
orch = payload.get("orchestration", "")

print("  Data-parallel worker (Rust WASM)")
print(f"  orchestration={orch} use_case={payload.get('use_case', '')}")
print("  Data size")
print(
...
print("  Result")
print(f"  weight_checksum={payload.get('weight_checksum', 0)}")
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${GREEN}Data-parallel worker test passed.${NC}"
