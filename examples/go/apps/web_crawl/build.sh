...
for candidate in \
  ...
  "$REPO_ROOT/examples/typescript/apps/abstractions/node_modules/@bytecodealliance/jco/lib/wasi_snapshot_preview1.reactor.wasm" \
...
echo "Building $ACTOR_NAME (Go WASM)..."
