...
EMBEDDED_WASM="$SCRIPT_DIR/ai_monitor_link_actor_embedded.wasm"
BUILD_PROFILE="${CARGO_PROFILE:-debug}"
PROFILE_FLAG=""
[ "$BUILD_PROFILE" = "release" ] && PROFILE_FLAG="--release"
CORE_WASM="$REPO_ROOT/target/wasm32-wasip1/$BUILD_PROFILE/ai_monitor_link_supervision.wasm"
...
echo "Building ai_monitor_link_supervision (Rust WASM)..."
