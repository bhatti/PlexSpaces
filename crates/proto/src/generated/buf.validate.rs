...
impl Ignore {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Ignore::IgnoreUnspecified => "IGNORE_UNSPECIFIED",
            Ignore::IgnoreIfZeroValue => "IGNORE_IF_ZERO_VALUE",
            Ignore::IgnoreAlways => "IGNORE_ALWAYS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "IGNORE_UNSPECIFIED" => Some(Self::IgnoreUnspecified),
            "IGNORE_IF_ZERO_VALUE" => Some(Self::IgnoreIfZeroValue),
            "IGNORE_ALWAYS" => Some(Self::IgnoreAlways),
            _ => None,
        }
    }
}
...
#[repr(i32)]
pub enum KnownRegex {
    KnownRegexUnspecified = 0,
    /// HTTP header name as defined by [RFC 7230](<https://datatracker.ietf.org/doc/html/rfc7230#section-3.2>).
    KnownRegexHttpHeaderName = 1,
    /// HTTP header value as defined by [RFC 7230](<https://datatracker.ietf.org/doc/html/rfc7230#section-3.2.4>).
    KnownRegexHttpHeaderValue = 2,
}
impl KnownRegex {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            KnownRegex::KnownRegexUnspecified => "KNOWN_REGEX_UNSPECIFIED",
            KnownRegex::KnownRegexHttpHeaderName => "KNOWN_REGEX_HTTP_HEADER_NAME",
            KnownRegex::KnownRegexHttpHeaderValue => "KNOWN_REGEX_HTTP_HEADER_VALUE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "KNOWN_REGEX_UNSPECIFIED" => Some(Self::KnownRegexUnspecified),
            "KNOWN_REGEX_HTTP_HEADER_NAME" => Some(Self::KnownRegexHttpHeaderName),
            "KNOWN_REGEX_HTTP_HEADER_VALUE" => Some(Self::KnownRegexHttpHeaderValue),
            _ => None,
        }
    }
}
