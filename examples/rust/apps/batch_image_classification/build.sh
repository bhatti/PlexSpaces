...
OUTPUT_WASM="$SCRIPT_DIR/batch_image_classification_actor.wasm"
EMBEDDED_WASM="$SCRIPT_DIR/batch_image_classification_embedded.wasm"
BUILD_PROFILE="${CARGO_PROFILE:-debug}"
PROFILE_FLAG=""
if [ "$BUILD_PROFILE" = "release" ]; then
  PROFILE_FLAG="--release"
fi
CORE_WASM="$REPO_ROOT/target/wasm32-wasip1/$BUILD_PROFILE/batch_image_classification_wasm.wasm"
...
echo "Building Batch Image Classification (Rust WASM)..."
